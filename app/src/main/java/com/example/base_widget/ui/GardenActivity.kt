...
import com.example.base_widget.databinding.ActivityGardenBinding
...
class GardenActivity: BaseActivity<ActivityGardenBinding>() {
    ...
    override fun inflateViewBinding() = ActivityGardenBinding.inflate(layoutInflater)
    ...
    private fun setUpRecyclerView() {
        ...
        binding.rvAllSeed.apply {
            ...
            adapter = shopAdapter
            layoutManager = GridLayoutManager(this@GardenActivity, 3)
        ...
        binding.rvAllPlant.apply {
            ...
            layoutManager = GridLayoutManager(this@GardenActivity, 4)
